...
/**
 * SubdistrictsSearch represents the model behind the search form of `backend\models\Subdistricts`.
 */
class SubdistrictsSearch extends Subdistricts
{
    ...
    {
        $query = (isset($params['sort']) && $params['sort']) ? Subdistricts::find() : Subdistricts::find()->orderBy(['id' => SORT_DESC]);
