...
use backend\models\JobCategoriesSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use backend\components\BaseController;
/**
 * JobCategoriesController implements the CRUD actions for JobCategories model.
 */
class JobCategoriesController extends BaseController
{
    ...
    /**
     * Lists all JobCategories models.
     * @return mixed
     */
    public function actionIndex() {
        ...
        $searchModel = new JobCategoriesSearch();
