...
use backend\models\PagesCategoriesSearch;
...
/**
 * PagesCategoriesController implements the CRUD actions for PagesCategories model.
 */
class PagesCategoriesController extends BaseController {
    ...
    /**
     * Lists all PagesCategories models.
     * @return mixed
     */
    public function actionIndex() {
        ...
        $searchModel = new PagesCategoriesSearch();
    ...
    /**
     * Finds the PagesCategories model based on its primary key value.
    ...
    protected function findModel($id) {
        if (($model = PagesCategories::findOne($id)) !== null) {
            return $model;
        }
