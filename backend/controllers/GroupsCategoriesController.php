...
use backend\models\GroupsCategoriesSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use backend\components\BaseController;
/**
 * GroupsCategoriesController implements the CRUD actions for GroupsCategories model.
 */
class GroupsCategoriesController extends BaseController
{
    const ACTIVE = 'Active';
    ...
    /**
     * Lists all GroupsCategories models.
     * @return mixed
     */
    public function actionIndex() {
        ...
        $searchModel = new GroupsCategoriesSearch();
    ...
    /**
     * Finds the GroupsCategories model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return GroupsCategories the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = GroupsCategories::findOne($id)) !== null) {
            return $model;
        }
