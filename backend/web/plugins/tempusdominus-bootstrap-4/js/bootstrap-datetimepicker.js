!(function (a) {
    ...
    var c = function (c, d) {
        var e,
            ...
            Y = function () {
                ...
                if(d.custompicker){
                    ...
                    for (var b = o.find(".timepicker-minutes table"), c = f.clone().startOf("h"), e = [], g = a("<tr>"), h = 1 === d.stepping ? 1 : d.stepping; f.isSame(c, "h"); ) 
                        //c.minute() % (4 * h) === 0 && ((g = a("<tr>")), e.push(g)), g.append('<td data-action="selectMinute" class="minute' + (R(c, "m") ? "" : " disabled") + '">' + c.format("mm") + "</td>"), c.add(h, "m");
                        //c.minute() % (4 * h) === 0 && ((g = a("<tr>")), e.push(g)),(c.format("HH") == '00' && (c.format("mm") == '01' || c.format("mm") == '15' || c.format("mm") == '30' || c.format("mm") == '45')) ? g.append('<td data-action="selectMinute" class="minute' + (R(c, "m") ? "" : " disabled") + '">' + c.format("mm") + "</td>") : (c.format("HH") == '23' && (c.format("mm") == '59' || c.format("mm") == '15' || c.format("mm") == '30' || c.format("mm") == '45'))?g.append('<td data-action="selectMinute" class="minute' + (R(c, "m") ? "" : " disabled") + '">' + c.format("mm") + "</td>"):g.append('<td data-action="selectMinute" class="minute' + (R(c, "m") ? "" : " disabled") + '">' + c.format("mm") + "</td>"), c.add(h, "m");

                        c.minute() % (4 * h) === 0 && ((g = a("<tr>")), e.push(g)), 
                            (c.format("HH") == '00') ? 
                               (c.format("mm") == '01' || c.format("mm") == '15' || c.format("mm") == '30' || c.format("mm") == '45')?
                                       g.append('<td data-action="selectMinute" class="minute' + (R(c, "m") ? "" : " disabled") + '">' + c.format("mm") + "</td>"):""
                            : 
                            (c.format("HH") == '23') ?
                                    (c.format("mm") == '59' || c.format("mm") == '15' || c.format("mm") == '30' || c.format("mm") == '45' || c.format("mm") == '00')?
                                            g.append('<td data-action="selectMinute" class="minute' + (R(c, "m") ? "" : " disabled") + '">' + c.format("mm") + "</td>"):""
                            :
                            (c.format("mm") == '00' || c.format("mm") == '15' || c.format("mm") == '30' || c.format("mm") == '45') ?
            ...
            ea = {
                ...
                incrementMinutes: function () {
                    if(d.custompicker){
                        ...
                        if(e.clone().format("HH") == '00' && e.clone().format("mm") == '01'){
                            var a = e.clone().add('14', "m");
                        }else if(e.clone().format("HH") == '23' && e.clone().format("mm") == '45'){
                            var a = e.clone().add('14', "m");
                        }else if(e.clone().format("HH") == '23' && e.clone().format("mm") == '59'){
                            var a = e.clone().add('02', "m");
                        }else{
                            var a = e.clone().add('15', "m");
                        }
                    }
                   // var a = e.clone().add(d.stepping, "m");
                    R(a, "m") && aa(a);c
                ...
                decrementMinutes: function () {
                    if(d.custompicker){
                        ...
                        if(e.clone().format("HH") == '00' && e.clone().format("mm") == '01'){
                            var a = e.clone().subtract('02', "m");
                        }else if(e.clone().format("HH") == '00' && e.clone().format("mm") == '15'){
                            var a = e.clone().subtract('14', "m");
                        }else if(e.clone().format("HH") == '23' && e.clone().format("mm") == '59'){
                            var a = e.clone().subtract('14', "m");
                        }else{
                            var a = e.clone().subtract('15', "m");
                        }
                    }
                    //var a = e.clone().subtract(d.stepping, "m");
                    R(a, "m") && aa(a);
                ...
                selectMinute: function (b) {
                    //console.log(parseInt(a(b.target).text(), 10));
        ...
        if (
            ...
            (l.custompicker = function (a) {
                if (0 === arguments.length) return d.custompicker;
//                if ("string" != typeof a) throw new TypeError("datepickerInput() expects a string parameter");
                return (d.custompicker = a), l;
            }),
            c.is("input"))
        )
            g = c;
