...
if (!empty(Yii::$app->BackFunctions->checkaccess('create', Yii::$app->controller->id))) {
    $createBtn = Html::a('<i class="fas fa-plus"></i>', FALSE, ['value' => Url::to(['job-categories/create']), 'title' => 'Create country', 'class' => 'showModalButton btn btn-primary']);
}
//Export
$exportBtn = '';
...
//                                    ],
                                ...
                                if (!empty(Yii::$app->BackFunctions->checkaccess('status', Yii::$app->controller->id))) {
                                    return Html::a($model->status,
                                                    ...
                                                    [
                                                        ...
                                                        'title' => $model->status,
                                                        'onclick' => '$.post({
                                                            url: "' . Yii::$app->homeUrl . 'job-categories/statusupdate?id=' . $model->id . '",
                                ...
                                'view' => function ($url, $model) {
                                    if (!empty(Yii::$app->BackFunctions->checkaccess('view', Yii::$app->controller->id))) {
                                        return Html::a(
                                                        ...
                                                        FALSE,
                                                        [
                                                            'value' => Url::to(['job-categories/view', 'id' => $model->id]),
                                                            'title' => 'View Job Category',
                                ...
                                'update' => function ($url, $model) {
                                    if (!empty(Yii::$app->BackFunctions->checkaccess('update', Yii::$app->controller->id))) {
                                        return Html::a(
                                                        ...
                                                        FALSE,
                                                        [
                                                            'value' => Url::to(['job-categories/update', 'id' => $model->id]),
                    ...
                    'itemLabelSingle' => 'Job Category',
                    'itemLabelPlural' => 'Job Categories',
                ]);
                ?>
            </div>
        </div>
...
<script type="text/javascript">
    function applyjs(e) {
        ...
        $.post({
            url: '<?= Yii::$app->homeUrl . 'job-categories/applystatus' ?>',
            dataType: 'json',
