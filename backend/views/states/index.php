...
if (!empty(Yii::$app->BackFunctions->checkaccess('create', Yii::$app->controller->id))) {
    $createBtn = Html::a('<i class="fas fa-plus"></i>', FALSE, ['value' => Url::to(['states/create']), 'title' => 'Create State', 'class' => 'showModalButton btn btn-primary']);
}
//Export
$exportBtn = '';
...
//                                    ],
                        [
                            ...
                            'value' => function ($model, $key, $index, $widget) {
                                if (!empty(Yii::$app->BackFunctions->checkaccess('index', 'districts'))) {
                                    return Html::a($model->english, Url::to(['/districts', 'DistrictsSearch[country_id]' => $model->country_id, 'DistrictsSearch[state_id]' => $model->id]), ['title' => 'View Districts', 'class' => '']);
                                }
                                ...
                                if (!empty(Yii::$app->BackFunctions->checkaccess('status', Yii::$app->controller->id))) {
                                    return Html::a($model->status,
                                                    ...
                                                    [
                                                        ...
                                                        'title' => $model->status,
                                                        'onclick' => '$.post({
                                                            url: "' . Yii::$app->homeUrl . 'states/statusupdate?id=' . $model->id . '",
                                ...
                                'view' => function ($url, $model) {
                                    if (!empty(Yii::$app->BackFunctions->checkaccess('view', Yii::$app->controller->id))) {
                                        return Html::a(
                                                        ...
                                                        FALSE,
                                                        [
                                                            'value' => Url::to(['states/view', 'id' => $model->id]),
                                                            'title' => 'View State',
                                ...
                                'update' => function ($url, $model) {
                                    if (!empty(Yii::$app->BackFunctions->checkaccess('update', Yii::$app->controller->id))) {
                                        return Html::a(
                                                        ...
                                                        FALSE,
                                                        [
                                                            'value' => Url::to(['states/update', 'id' => $model->id]),
                                                            'title' => 'Edit State',
                    ...
                    'toolbar' => [
                        [
                            ...
                            Html::a('<i class="fas fa-arrow-left"></i>', Url::to(['/countries']), ['title' => 'View Countries', 'class' => 'btn btn-outline-dark']).
                            Html::a('<i class="fas fa-arrow-right"></i>', Url::to(['/districts']), ['title' => 'View Districts', 'class' => 'btn btn-outline-dark']),
...
<script type="text/javascript">
    function applyjs(e) {
        ...
        $.post({
            url: '<?= Yii::$app->homeUrl . 'states/applystatus' ?>',
            dataType: 'json',
