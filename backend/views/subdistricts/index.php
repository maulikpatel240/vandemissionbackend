...
if (!empty(Yii::$app->BackFunctions->checkaccess('create', Yii::$app->controller->id))) {
    $createBtn = Html::a('<i class="fas fa-plus"></i>', FALSE, ['value' => Url::to(['subdistricts/create']), 'title' => 'Create Subdistrict', 'class' => 'showModalButton btn btn-primary']);
}
//Export
$exportBtn = '';
...
//                                    ],
                        [
                            ...
                            'value' => function ($model, $key, $index, $widget) {
                                if (!empty(Yii::$app->BackFunctions->checkaccess('index', 'villages'))) {
                                    return Html::a($model->english, Url::to(['/villages','VillagesSearch[country_id]' => $model->country_id, 'VillagesSearch[state_id]' => $model->state_id, 'VillagesSearch[district_id]' => $model->district_id, 'VillagesSearch[city_id]' => $model->id]), ['title' => 'View States', 'class' => '']);
                                }
                                ...
                                if (!empty(Yii::$app->BackFunctions->checkaccess('status', Yii::$app->controller->id))) {
                                    return Html::a($model->status,
                                                    ...
                                                    [
                                                        ...
                                                        'title' => $model->status,
                                                        'onclick' => '$.post({
                                                            url: "' . Yii::$app->homeUrl . 'subdistricts/statusupdate?id=' . $model->id . '",
                                ...
                                'view' => function ($url, $model) {
                                    if (!empty(Yii::$app->BackFunctions->checkaccess('view', Yii::$app->controller->id))) {
                                        return Html::a(
                                                        ...
                                                        FALSE,
                                                        [
                                                            'value' => Url::to(['subdistricts/view', 'id' => $model->id]),
                                                            'title' => 'View Subdistrict',
                                ...
                                'update' => function ($url, $model) {
                                    if (!empty(Yii::$app->BackFunctions->checkaccess('update', Yii::$app->controller->id))) {
                                        return Html::a(
                                                        ...
                                                        FALSE,
                                                        [
                                                            'value' => Url::to(['subdistricts/update', 'id' => $model->id]),
                    ...
                    'toolbar' => [
                        [
                            ...
                            Html::a('<i class="fas fa-arrow-left"></i>', Url::to(['/districts']), ['title' => 'View States', 'class' => 'btn btn-outline-dark']).
                            Html::a('<i class="fas fa-arrow-right"></i>', Url::to(['/villages']), ['title' => 'View Cities', 'class' => 'btn btn-outline-dark']),
                    ...
                    'itemLabelSingle' => 'Subdistrict',
                    'itemLabelPlural' => 'Subdistricts',
                ]);
                ?>
            </div>
        </div>
...
<script type="text/javascript">
    function applyjs(e) {
        ...
        $.post({
            url: '<?= Yii::$app->homeUrl . 'subdistricts/applystatus' ?>',
            dataType: 'json',
