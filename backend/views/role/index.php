...
if (!empty(Yii::$app->BackFunctions->checkaccess('create', Yii::$app->controller->id))) {
    $createBtn = Html::a('<i class="fas fa-plus"></i>', FALSE, ['value' => Url::to(['role/create']), 'title' => 'Create Module', 'class' => 'showModalButton btn btn-primary']);
}
//Export
$exportBtn = '';
...
//                                    ],
                        ...
                        [
                            'attribute' => 'panel',
                            'filter' => ["Backend" => "Backend", "Frontend" => "Frontend"]
                        ],
                        [
                                ...
                                if (!empty(Yii::$app->BackFunctions->checkaccess('status', Yii::$app->controller->id))) {
                                    return Html::a($model->status,
                                                    ...
                                                    [
                                                        ...
                                                        'title' => $model->status,
                                                        'onclick' => '$.post({
                                                        url: "' . Yii::$app->homeUrl . 'role/statusupdate?id=' . $model->id . '",
                                ...
                                'view' => function ($url, $model) {
                                    if (!empty(Yii::$app->BackFunctions->checkaccess('view', Yii::$app->controller->id))) {
                                        return Html::a(
                                                ...
                                                FALSE,
                                                [
                                                    'value' => Url::to(['role/view', 'id' => $model->id]),
                                                    'title' => 'View Role',
                                ...
                                'update' => function ($url, $model) {
                                    if (!empty(Yii::$app->BackFunctions->checkaccess('update', Yii::$app->controller->id))) {
                                        return Html::a(
                                                ...
                                                FALSE,
                                                [
                                                    'value' => Url::to(['role/update', 'id' => $model->id]),
                                                    'title' => 'Edit Role',
...
<script type="text/javascript">
    function applyjs(e) {
        ...
        $.post({
            url: '<?= Yii::$app->homeUrl . 'role/applystatus' ?>',
            dataType: 'json',
