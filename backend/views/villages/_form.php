...
<div class="subdistricts-form">
    ...
    <?php /*
      ...
      'data' => ArrayHelper::map(Districts::find()->where(['status' => 'Active'])->asArray()->all(), 'id', 'english'),
      'options' => ['placeholder' => 'Select ...'],
      'type' => DepDrop::TYPE_SELECT2,
      'select2Options' => ['pluginOptions' => ['allowClear' => true]],
      'pluginOptions' => [
      'depends' => ['villages-state_id'],
      'url' => Url::to(['/requests/districts']),
      'loadingText' => '',
      ]
      ]);
      ?>
      ...
      'select2Options' => ['pluginOptions' => ['allowClear' => true]],
      'pluginOptions' => [
      'depends' => ['villages-district_id'],
      'url' => Url::to(['/requests/subdistricts']),
      'loadingText' => '',
      ]
      ]);
      ?>
      ...
      <div class="col-sm-12 col-md-6 col-lg-6">
      <?=
      $form->field($model, 'block_id')->widget(DepDrop::classname(), [
      'data' => ArrayHelper::map(Districts::find()->where(['status' => 'Active'])->asArray()->all(), 'id', 'english'),
      'options' => ['placeholder' => 'Select ...'],
      'type' => DepDrop::TYPE_SELECT2,
      'select2Options' => ['pluginOptions' => ['allowClear' => true]],
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-6 col-lg-6">
            <div class="file-upload">
                ...
                $image_url = ($model->map) ? Yii::$app->urlManager->baseUrl . '/uploads/map/village/' . $model->map : '#';
